...
class Chat extends Component {
  ...
  GroupDetails123 = async () => {
    ...
    await fetch("http://192.168.100.150:3000/SendGroupDetails", {
      headers: {
  ...
  Select1 = async (data, data1) => {
    ...
    if (data1 !== this.state.UserName) {
      ...
      fetch("http://192.168.100.150:3000/FindGroupMessage", {
        headers: {
          Accept: "application/json",
          "Content-type": "application/json"
        },
  ...
  async componentDidMount() {
    ...
    if (username === null) {
      ...
      fetch("http://192.168.100.150:3000/CheckLogin", {
        headers: {
          Accept: "application/json",
          "Content-type": "application/json"
        },
        ...
        .then(resp => {
          if (resp.data === "Allowed") {
            ...
            fetch("http://192.168.100.150:3000/SignUps", {
              headers: {
                Accept: "application/json",
                "Content-type": "application/json"
              },
            ...
            fetch("http://192.168.100.150:3000/SendGroupDetails", {
              headers: {
                Accept: "application/json",
                "Content-type": "application/json"
              },
  ...
  UpdateUser = () => {
    fetch("http://192.168.100.150:3000/UpdateAllUser", {
      headers: {
        Accept: "application/json",
        "Content-type": "application/json"
      },
  ...
  Logout = async () => {
    ...
    fetch("http://192.168.100.150:3000/ChangeStatus", {
      headers: {
        Accept: "application/json",
        "Content-type": "application/json"
      },
  ...
  SeenMsgUpdate = data => {
    fetch("http://192.168.100.150:3000/ChangeSeenStatus", {
      headers: {
        Accept: "application/json",
        "Content-type": "application/json"
      },
      ...
      if (this.state.UserName === this.state.OwnUsername) {
        ...
        if (this.state.text === "") {
          ...
          if (this.state.GroupClient !== true) {
            fetch("http://192.168.100.150:3000/SaveMessages", {
              headers: {
                Accept: "application/json",
                "Content-type": "application/json"
              },
            ...
            fetch("http://192.168.100.150:3000/SaveGroupMessages", {
              headers: {
                Accept: "application/json",
                "Content-type": "application/json"
              },
  ...
  AddAll = async () => {
    if (this.state.showNext !== true && SetGroupUser.length !== 0) {
      ...
      if (this.state.GroupName !== "") {
        ...
        fetch("http://192.168.100.150:3000/AddGroupDetails", {
          headers: {
            Accept: "application/json",
            "Content-type": "application/json"
          },
  ...
  Select = async data => {
    ...
    if (data !== this.state.UserName) {
      ...
      fetch("http://192.168.100.150:3000/Find", {
        headers: {
          Accept: "application/json",
          "Content-type": "application/json"
        },
  ...
  AddGroup = async () => {
    ...
    SetGroupUser = [];
    fetch("http://192.168.100.150:3000/GroupAdd", {
      headers: {
        Accept: "application/json",
        "Content-type": "application/json"
      },
